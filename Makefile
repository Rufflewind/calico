...
build: include/calico/arithmetic.h include/calico/arithmetic_impl_g.h include/calico/binary_search.h include/calico/btree.hpp include/calico/btree_head.h include/calico/btree_impl.h include/calico/btree_template.h include/calico/btree_template_impl_g.h include/calico/compat/alignas_begin.h include/calico/compat/alignas_end.h include/calico/compat/alloca.h include/calico/compat/inline_begin.h include/calico/compat/inline_end.h include/calico/compat/noreturn_begin.h include/calico/compat/noreturn_end.h include/calico/compat/restrict_begin.h include/calico/compat/restrict_end.h include/calico/compat/static_assert_begin.h include/calico/compat/static_assert_end.h include/calico/linear_ordered_search.h include/calico/macros.h include/calico/shuffle.h include/calico/wclock.h prepare

build-bench: tmp/bench-btree tmp/bench-stdmap++

build-check: tmp/test-binary_search tmp/test-btree tmp/test-btree++ tmp/test-frozen_btree tmp/test-shuffle tmp/test-stdmap++ tmp/test-wclock

check: run-test-binary_search run-test-btree run-test-btree++ run-test-frozen_btree run-test-shuffle run-test-stdmap++ run-test-wclock

clean:
	rm -fr -- include/calico/arithmetic.h include/calico/arithmetic_impl_g.h include/calico/binary_search.h include/calico/btree.hpp include/calico/btree_head.h include/calico/btree_impl.h include/calico/btree_template.h include/calico/btree_template_impl_g.h include/calico/compat/alignas_begin.h include/calico/compat/alignas_end.h include/calico/compat/alloca.h include/calico/compat/inline_begin.h include/calico/compat/inline_end.h include/calico/compat/noreturn_begin.h include/calico/compat/noreturn_end.h include/calico/compat/restrict_begin.h include/calico/compat/restrict_end.h include/calico/compat/static_assert_begin.h include/calico/compat/static_assert_end.h include/calico/linear_ordered_search.h include/calico/macros.h include/calico/shuffle.h include/calico/wclock.h src/arithmetic_impl_g.h src/binary_search_test.c.o src/black_box.c.o src/black_box_bench.c.o src/btree_impl_ids.txt src/btree_template_impl_g.h src/btree_test.c.o src/btree_test.cpp.o src/btree_test_bench.c.o src/frozen_btree_test.c.o src/shuffle_test.c.o src/stdmap_test.cpp.o src/stdmap_test_bench.cpp.o src/wclock_test.c.o tmp/bench-btree tmp/bench-stdmap++ tmp/test-binary_search tmp/test-btree tmp/test-btree++ tmp/test-frozen_btree tmp/test-shuffle tmp/test-stdmap++ tmp/test-wclock
...
.PHONY: all build build-bench build-check check clean deploy-doc doc prepare run-test-binary_search run-test-btree run-test-btree++ run-test-frozen_btree run-test-shuffle run-test-stdmap++ run-test-wclock
